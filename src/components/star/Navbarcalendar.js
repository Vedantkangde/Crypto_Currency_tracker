          ...
          <Nav scrollNav={scrollNav}>
              <NavbarContainer>
                  ...
                  <NavMenu>
                      <NavItem>
                          <NavLinks to='stars'
                          smooth={true} duration={500} spy ={true} exact='true' offset={-80} >Constellation</NavLinks>
                     </NavItem>
                     <NavItem>
                          <NavLinks to='stars1' smooth={true} duration={500} spy ={true} exact='true' offset={-80}>Stars</NavLinks>
                     </NavItem>
                     <NavItem>
                          <NavLinks to='stars2' smooth={true} duration={500} spy ={true} exact='true' offset={-80}>Nebulaes</NavLinks>
                     </NavItem>
                     <NavItem>
